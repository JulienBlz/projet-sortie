...
class Sortie
{
    ...
    /**
     * @Assert\NotBlank(message="Merci d'indiquer le nom.")
    ...
    /**
     * @Assert\GreaterThan("today", message="La date de début ne peut pas être déja passée.")
     * @Assert\NotBlank(message="Merci d'indiquer la date et l'heure de début.")
    ...
    /**
     * @Assert\NotBlank(message="Merci d'indiquer la date de limite d'inscription.")
    ...
    public function setSiteOrganisateur(?Campus $site_organisateur): self
    {
